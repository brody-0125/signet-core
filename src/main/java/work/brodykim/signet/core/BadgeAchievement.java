...
public record BadgeAchievement(
        ...
        String imageUrl,
        List<String> tags,
        List<BadgeAlignment> alignments,
        String creator,
        Float creditsAvailable,
        String fieldOfStudy,
        String humanCode,
        String inLanguage,
        List<BadgeIdentifierEntry> otherIdentifier,
        List<BadgeRelated> related,
        List<BadgeResultDescription> resultDescription,
     ...
     */
    public BadgeAchievement(UUID id, String name, String description,
                            String criteriaNarrative, String criteriaUrl,
                            String achievementType, String imageUrl,
                            List<String> tags, List<BadgeAlignment> alignments) {
        this(id, name, description, criteriaNarrative, criteriaUrl,
                achievementType, imageUrl, tags, alignments,
     ...
     */
    public BadgeAchievement(UUID id, String name, String description,
                            String criteriaNarrative, String achievementType,
                            String imageUrl, List<String> tags) {
        this(id, name, description, criteriaNarrative, null, achievementType, imageUrl, tags, null,
                null, null, null, null, null, null, null, null, null, null);
    }
}
